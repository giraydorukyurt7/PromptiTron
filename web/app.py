...
class WebUIManager:
    ...
    def classify_intent(self, user_input: str) -> dict:
        ...
        elif any(word in user_lower for word in ["plan", "calisma", "program", "takvim"]):
            return {
                "type": "study_plan",
                "profile": self.get_current_profile()
            }
        elif any(word in user_lower for word in ["analiz", "degerlendir", "incele"]):
            return {
...
def export_data(format):
    ...
    try:
        ...
        if format == 'json':
            ...
            content = "# Promptitron Konusma Gecmisi\n\n"
            ...
            filename = generate_pdf_report(content, "Konusma Gecmisi")
            if not filename:
    ...
    try:
        ...
        for subject in curriculum_loader.curriculum_data.keys():
            ...
            curriculum_data[subject] = {
                ...
                "grades": grades,
                "summary": f"{len(topics)} konular {len(grades)} sinif seviyesinde"
            }
