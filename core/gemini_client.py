            ...
            if use_rag:
                try:
                    ...
                    if search_results:
                        ...
                        enhanced_prompt = f"""Asagidaki baglam bilgilerini kullanarak soruyu cevapla:
...
Lutfen baglam bilgilerini kullanarak dogru ve detayli bir cevap ver. Baglamda olmayan bilgiler hakkinda spekulasyon yapma."""
            ...
            if response.get("success", True) and response.get("text") and validation_level != "none":
                ...
                if confidence_score < 0.6:
                    response["warning"] = "Dusuk guvenilirlik: Icerik dogrulanmali"
                elif rag_score < 0.5 and use_rag:
                    response["warning"] = "Sinirli baglam: Daha fazla kaynak gerekebilir"
