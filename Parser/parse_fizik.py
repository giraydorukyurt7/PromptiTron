...
pdf_path = "lectures/fizik.pdf"
output_path = "kazanimlar_fizik.json"
...
while i < len(lines):
    ...
    if match:
        ...
        data["yks"]["fizik"].setdefault(current_grade, {"alt": {}})
        current_unit = None
        current_topic = None
        print(f"\n🎓 Sınıf: {current_grade}")
        i += 1
    ...
    if match:
        ...
        if current_grade is not None:
            data["yks"]["fizik"][current_grade]["alt"].setdefault(current_unit, {
            ...
            while j < len(lines):
                ...
                if kw_match:
                    ...
                    while k < len(lines) and not re.match(r"^\d", lines[k]):
                        ...
                        k += 1
                    data["yks"]["fizik"][current_grade]["alt"][current_unit]["anahtar_kavramlar"] = keywords
    ...
    if match and current_unit:
        ...
        data["yks"]["fizik"][current_grade]["alt"][current_unit]["alt"].setdefault(current_topic, {
    ...
    if match and current_topic:
        ...
        while j < len(lines):
            ...
            # Erken sınıf geçişi kontrolü (örnek: 10. SINIF ÜNİTE... açıklama içinde çıkıyor olabilir)
        ...
        data["yks"]["fizik"][current_grade]["alt"][current_unit]["alt"][current_topic]["alt"][kazanım_kodu] = {
